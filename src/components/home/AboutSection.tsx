...
const BACKGROUND_IMAGES = [
  ...
  { src: "/images/harsh_vardhan_yadav_MsKGTatzcrA_unsplash.jpg", bottom: "-5%", right: "-5%", rotate: "18deg", width: "420px", height: "320px" },
  { src: "/images/poha_jalebi.jpg", top: "35%", right: "35%", rotate: "11deg", width: "240px", height: "240px" },
